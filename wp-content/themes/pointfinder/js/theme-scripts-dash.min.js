...
var marker=$('#pfupload_map').gmap3({get:"marker"});marker.setPosition(place.geometry.location);$("#pfupload_lat_coordinate").val(marker.getPosition().lat());$("#pfupload_lng_coordinate").val(marker.getPosition().lng());if($.pfstreetview_status=='active'){$('#pfitempagestreetviewMap').data('pfcoordinateslat',marker.getPosition().lat());$('#pfitempagestreetviewMap').data('pfcoordinateslng',marker.getPosition().lng());var latLng=new google.maps.LatLng(marker.getPosition().lat(),marker.getPosition().lng());$.pfstmapdestroy();$.pfstmapregenerate();$.panoramamap.setCenter(latLng);$.pfpanoramamap.setPosition(latLng);$.pfstviewgetnow(100);}});},1000);}
$("#pf_search_geolocateme").on("click",function(){$(".pf-search-locatemebut").hide("fast");$(".pf-search-locatemebutloading").show("fast");$('#pfupload_map').gmap3({getgeoloc:{callback:function(latLng){if(latLng){var geocoder=new google.maps.Geocoder();geocoder.geocode({"latLng":latLng},function(results,status){if(status==google.maps.GeocoderStatus.OK){if(results[0]){var map=$('#pfupload_map').gmap3("get");map.setCenter(latLng);map.setZoom(17);var marker=$('#pfupload_map').gmap3({get:"marker"});marker.setPosition(latLng);$("#pfupload_address").val(results[0].formatted_address);$("#pfupload_lat_coordinate").val(latLng.lat());$("#pfupload_lng_coordinate").val(latLng.lng());$('#pfitempagestreetviewMap').data('pfcoordinateslat',latLng.lat());$('#pfitempagestreetviewMap').data('pfcoordinateslng',latLng.lng());$.pfstmapdestroy();$.pfstmapregenerate();$.panoramamap.setCenter(latLng);$.pfpanoramamap.setPosition(latLng);$.pfstviewgetnow(100);}}});}
...
$('.pfitemdetailcheckall').on('click',function(event){$.each($('[name="pffeature[]"]'),function(index,val){$(this).attr('checked',true);});});$('.pfitemdetailuncheckall').on('click',function(event){$.each($('[name="pffeature[]"]'),function(index,val){$(this).attr('checked',false);});});$.each($('[name="pffeature[]"]'),function(index,el){var parent_element=$(this)
var parent_val=parent_element.data('parent');var status_of_attr=parent_element.attr('checked');if(parent_val=="yes"){if(status_of_attr=='checked'){var parent_id_val=parent_element.data('pid');var childs_of_this=$('.pffeature'+parent_id_val);$.each(childs_of_this,function(index,val){$(this).prop('disabled',false);});}}});$('[name="pffeature[]"]').on('click',function(event){var parent_element=$(this)
var parent_val=parent_element.data('parent');var status_of_attr=parent_element.attr('checked');if(parent_val=="yes"){var child_val=parent_element.data('child');var childof_val=parent_element.data('childof');var parent_id_val=parent_element.data('pid');var childs_of_this=$('.pffeature'+parent_id_val);if(status_of_attr=='checked'){$.each(childs_of_this,function(index,val){$(this).prop('disabled',false);$(this).attr('checked',true);});}else{$.each(childs_of_this,function(index,val){$(this).prop('disabled',true);$(this).attr('checked',false);});}}});}
...
if(obj.customtabs==null||obj.customtabs==''||obj.customtabs=='undefined'){$('.customtab-output-container').hide();}else{$('.customtab-output-container').html(obj.customtabs);$('.customtab-output-container').show();setTimeout(function(){if($('textarea[name="webbupointfinder_item_custombox1"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox1');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox1');}
$('textarea[name="webbupointfinder_item_custombox1"]').hide();}
if($('textarea[name="webbupointfinder_item_custombox2"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox2');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox2');}
$('textarea[name="webbupointfinder_item_custombox2"]').hide();}
if($('textarea[name="webbupointfinder_item_custombox3"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox3');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox3');}
$('textarea[name="webbupointfinder_item_custombox3"]').hide();}
if($('textarea[name="webbupointfinder_item_custombox4"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox4');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox4');}
$('textarea[name="webbupointfinder_item_custombox4"]').hide();}
if($('textarea[name="webbupointfinder_item_custombox5"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox5');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox5');}
$('textarea[name="webbupointfinder_item_custombox5"]').hide();}
if($('textarea[name="webbupointfinder_item_custombox6"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){tinyMCE.execCommand('mceRemoveEditor',true,'webbupointfinder_item_custombox6');tinyMCE.execCommand('mceAddEditor',true,'webbupointfinder_item_custombox6');}
$('textarea[name="webbupointfinder_item_custombox6"]').hide();}},0);}
...
$('.pfsubmit-inner-customfields').pfLoadingOverlay({action:'hide'});$('.pfsubmit-inner-features').pfLoadingOverlay({action:'hide'});}).complete(function(obj){}).error(function(jqXHR,textStatus,errorThrown){console.log(errorThrown);});}
$("#pf-ajax-uploaditem-button").on("click touchstart",function(){var form=$("#pfuaprofileform");if($('textarea[name="item_desc"]').hasClass('textarea')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="item_desc"]').html(tinyMCE.get('item_desc').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox1"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox1"]').html(tinyMCE.get('webbupointfinder_item_custombox1').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox2"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox2"]').html(tinyMCE.get('webbupointfinder_item_custombox2').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox3"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox3"]').html(tinyMCE.get('webbupointfinder_item_custombox3').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox4"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox4"]').html(tinyMCE.get('webbupointfinder_item_custombox4').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox5"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox5"]').html(tinyMCE.get('webbupointfinder_item_custombox5').getContent());}}
if($('textarea[name="webbupointfinder_item_custombox6"]').hasClass('textareaadv')){if(typeof(tinyMCE)!="undefined"){$('textarea[name="webbupointfinder_item_custombox6"]').html(tinyMCE.get('webbupointfinder_item_custombox6').getContent());}}
form.validate();if(!form.valid()){if($('#pfupload_listingtypes').hasClass('pfnotvalid')){$('.pfsubmit-inner-listingtype').addClass('pfnotvalid');}else{$('.pfsubmit-inner-listingtype').removeClass('pfnotvalid');};if($('#pfupload_locations').hasClass('pfnotvalid')){$('.pfsubmit-location-errc').addClass('pfnotvalid');}else{$('.pfsubmit-location-errc').removeClass('pfnotvalid');};if($('.pfuploadimagesrc').hasClass('pfnotvalid')){$('.pfitemimgcontainer').addClass('pfnotvalid');}else{$('.pfitemimgcontainer').removeClass('pfnotvalid');};if($('#pfuploadfilesrc').hasClass('pfnotvalid')){$('.pfitemfilecontainer').addClass('pfnotvalid');}else{$('.pfitemfilecontainer').removeClass('pfnotvalid');};if($('#pfupload_sublistingtypes').hasClass('pfnotvalid')){$('#s2id_pfupload_sublistingtypes input').addClass('pfnotvalid');}else{$('#s2id_pfupload_sublistingtypes input').removeClass('pfnotvalid');};if($('#pfupload_subsublistingtypes').hasClass('pfnotvalid')){$('#s2id_pfupload_subsublistingtypes input').addClass('pfnotvalid');}else{$('#s2id_pfupload_subsublistingtypes input').removeClass('pfnotvalid');};if($('#pfupload_address').hasClass('pfnotvalid')||$('#pfupload_lat_coordinate').hasClass('pfnotvalid')||$('#pfupload_lng_coordinate').hasClass('pfnotvalid')){$('.pfsubmit-address-errc').addClass('pfnotvalid');$('#pfupload_address').removeClass('pfnotvalid');$('#pfupload_lat_coordinate').removeClass('pfnotvalid');$('#pfupload_lng_coordinate').removeClass('pfnotvalid');}else{$('.pfsubmit-address-errc').removeClass('pfnotvalid');};if($('#item_desc').hasClass('pfnotvalid')){if(typeof(tinyMCE)!="undefined"){tinymce.activeEditor.contentDocument.body.style.backgroundColor='#F0D7D7';}}else{if(typeof(tinyMCE)!="undefined"){if($('#item_desc').hasClass('textarea')){tinymce.activeEditor.contentDocument.body.style.backgroundColor='#ffffff'}}};$.pfscrolltotop();return false;}else{$("#pf-ajax-uploaditem-button").val(theme_scriptspfm.buttonwait);$("#pf-ajax-uploaditem-button").attr("disabled",true);if($("#pf-ajax-uploaditem-button").data('edit')>0){$.pfOpenItemUpEditModal('open','edit',form.serialize());}else{$.pfOpenItemUpEditModal('open','upload',form.serialize());};return false;};});$(".pf-itemdelete-link").on("click touchstart",function(){if(confirm(theme_scriptspfm.delmsg)){$.pfOpenItemUpEditModal('open','delete',$(this).data('pid'));};});$.pfOpenItemUpEditModal=function(status,modalname,formdata){$.pfdialogstatus='';if(status=='open'){if($.pfdialogstatus=='true'){$("#pf-membersystem-dialog").dialog("close");}
...
return false;});$(".pf-delete-coverimg-old").live("click",function(){var deleting_item=$(this).data("pfimgno");var post_id=$(this).data("pfpid");if(confirm("Are you sure want to delete this item? (This action can not be rollback.")){$.ajax({beforeSend:function(){$('.pfuploadedcoverimages').pfLoadingOverlay({action:'show'});},url:theme_scriptspf.ajaxurl,type:'POST',dataType:'html',data:{action:'pfget_imagesystem',iid:deleting_item,id:post_id,oldup:1,process:'d2',security:theme_scriptspfm.pfget_imagesystem},}).done(function(obj){$.pfitemdetail_listcoverimages_old(post_id);$.pfuploadcoverimagelimit=$.pfuploadcoverimagelimit+1;if($.pfuploadcoverimagelimit>0){$('.pfuploadcoverimgupl-container').css('display','inline-block');}})}
return false;});$.pfitemdetail_listimages_old=function(id){$.ajax({beforeSend:function(){$('.pfuploadedimages').pfLoadingOverlay({action:'show'});},url:theme_scriptspf.ajaxurl,type:'POST',dataType:'html',data:{action:'pfget_imagesystem',id:id,oldup:1,process:'l',security:theme_scriptspfm.pfget_imagesystem},}).done(function(obj){$('.pfuploadedimages').html(obj);})};$.pfitemdetail_listcoverimages_old=function(id){$.ajax({beforeSend:function(){$('.pfuploadedcoverimages').pfLoadingOverlay({action:'show'});},url:theme_scriptspf.ajaxurl,type:'POST',dataType:'html',data:{action:'pfget_imagesystem',id:id,oldup:1,process:'l2',security:theme_scriptspfm.pfget_imagesystem},}).done(function(obj){$('.pfuploadedcoverimages').html(obj);})};$(".pf-change-standartimg-old").live("click",function(){var changing_item=$(this).data("pfimgno");var post_id=$(this).data("pfpid");$.ajax({beforeSend:function(){$('.pfuploadedimages').pfLoadingOverlay({action:'show'});},url:theme_scriptspf.ajaxurl,type:'POST',dataType:'html',data:{action:'pfget_imagesystem',iid:changing_item,id:post_id,process:'c',oldup:1,security:theme_scriptspfm.pfget_imagesystem},}).done(function(obj){$.pfitemdetail_listimages_old(post_id);})
...
return false;});$("body").on('click touchstart',".pfstatusbuttonaction",function(event){var pid=$(this).data('pfid');var atext=$(this).data('pf-active');var dtext=$(this).data('pf-deactive');var thisitem=$(this);$.ajax({beforeSend:function(){$('.pfmu-itemlisting-inner'+pid).pfLoadingOverlay({action:'show'});},type:'POST',dataType:'json',url:theme_scriptspf.ajaxurl,data:{'action':'pfget_onoffsystem','itemid':pid,'lang':theme_scriptspfm.pfcurlang,'security':theme_scriptspfm.pfget_onoffsystem}}).done(function(obj){if(obj==1){thisitem.switchClass('pfstatusbuttonactive','pfstatusbuttondeactive');thisitem.attr('title',dtext);$('.pfmu-itemlisting-inner-overlay'+pid).css('display','block');}else{thisitem.switchClass('pfstatusbuttondeactive','pfstatusbuttonactive');thisitem.attr('title',atext);$('.pfmu-itemlisting-inner-overlay'+pid).css('display','none');};$('.pfmu-itemlisting-inner'+pid).pfLoadingOverlay({action:'hide'});})});$(function(){$('#mceu_12').live('click',function(event){wpLink.open();return false;});});$(function(){if($.pfstreetview_status=='active'){$.pfcormarker=$("#pfupload_map").gmap3({get:{id:"Perpignan"}});$.pfstviewgetnow=function(delayt){setTimeout(function(){$.pfpanoramamap=$("#pfitempagestreetviewMap").gmap3({get:{name:"streetviewpanorama"}});var current_heading=parseFloat($("#webbupointfinder_item_streetview-heading").val());var current_pitch=parseFloat($("#webbupointfinder_item_streetview-pitch").val());var current_zoom=parseInt($("#webbupointfinder_item_streetview-zoom").val());$.pfmapHeading=$.pfpanoramamap.getPov().heading;$.pfmapPitch=$.pfpanoramamap.getPov().pitch;$.pfmapZoom=$.pfpanoramamap.getPov().zoom;setTimeout(function(){$.pfpanoramamap.addListener('pov_changed',function(){$("#webbupointfinder_item_streetview-heading").val($.pfpanoramamap.getPov().heading);$("#webbupointfinder_item_streetview-pitch").val($.pfpanoramamap.getPov().pitch)
$("#webbupointfinder_item_streetview-zoom").val($.pfpanoramamap.getPov().zoom)});},delayt);},delayt);}
google.maps.event.addListener($.pfcormarker,'dragend',function(event)
{$.pfstmapdestroy();$.pfstmapregenerate();$.panoramamap.setCenter(event.latLng);$.pfpanoramamap.setPosition(event.latLng);$.pfstviewgetnow(100);});$.pfstmapregenerate=function(){console.log('STW Generate Run');var current_heading=parseFloat($("#webbupointfinder_item_streetview-heading").val());var current_pitch=parseFloat($("#webbupointfinder_item_streetview-pitch").val());var current_zoom=parseInt($("#webbupointfinder_item_streetview-zoom").val());var pfitemcoordinatesLat=parseFloat($("#pfitempagestreetviewMap").data('pfcoordinateslat'));var pfitemcoordinatesLng=parseFloat($("#pfitempagestreetviewMap").data('pfcoordinateslng'));var pfitemzoom=parseInt($("#pfitempagestreetviewMap").data('pfzoom'));var testcoors=[pfitemcoordinatesLat,pfitemcoordinatesLng];var pfitemcoordinates_output=new google.maps.LatLng(testcoors[0],testcoors[1]);if($('.pfupload_map').data('pf-lng')=='undefied'){var defaultlocl=new google.maps.LatLng(40.71275,-74.00597);}else{var defaultlocl=new google.maps.LatLng($('.pfupload_map').data('pf-lat'),$('.pfupload_map').data('pf-lng'));}
var curlatLng=(pfitemcoordinatesLat)?pfitemcoordinates_output:defaultlocl;if(current_heading!=0&&current_pitch!=0){$('.pfitempagestreetview').remove();$("#pfitempagestreetviewMap").gmap3({map:{options:{zoom:pfitemzoom,mapTypeId:google.maps.MapTypeId.ROADMAP,streetViewControl:true,center:pfitemcoordinates_output},callback:function(map){$.panoramamap=map;}},streetviewpanorama:{options:{id:"streetviewpanorama",name:"streetviewpanorama",container:$(document.createElement("div")).addClass("pfitempagestreetview").insertAfter($("#pfitempagestreetviewMap")),opts:{position:pfitemcoordinates_output,pov:{heading:current_heading,pitch:current_pitch,zoom:current_zoom}}}}});}else{$("#pfitempagestreetviewMap").gmap3({map:{options:{zoom:pfitemzoom,mapTypeId:google.maps.MapTypeId.ROADMAP,streetViewControl:true,center:curlatLng},callback:function(map){$.panoramamap=map;}},streetviewpanorama:{options:{id:"streetviewpanorama",container:$(document.createElement("div")).addClass("pfitempagestreetview").insertAfter($("#pfitempagestreetviewMap")),opts:{position:curlatLng,pov:{heading:90,pitch:5,zoom:1}}}}});};}
$.pfstmapdestroy=function(){$('#pfitempagestreetviewMap').gmap3('destroy').html('<div id="pfitempagestreetviewMap"></div>');$('.pfitempagestreetview').remove();}
setTimeout(function(){$.pfstmapregenerate();},2000);$.pfstviewgetnow(3000);}})})(jQuery);