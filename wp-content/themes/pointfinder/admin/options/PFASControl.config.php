                ...
                $this->sections[] = array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                ...
                                'type'  => 'image_select',
                                'title'     => esc_html__('Sidebar Position : Blog Search Results Page', 'pointfindert2d'),
                                'subtitle' => esc_html__('This settings only cover blog category page.', 'pointfindert2d'),
                                'desc' => esc_html__('Please edit widgets on Appearance > Widgets > PF Blog Search Sidebar', 'pointfindert2d'),
                                'options'   => $pf_sidebar_options,
                                'default'   => '2'
                            ),
                            array(
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                                ...
                                'notice'    => true,
                                'style'     => 'info',
                                'desc'      => esc_html__('Our multiple currency system changed with PointFinder v1.8.8 Please update your API key for continue to use multiple currency system.', 'pointfindert2d').'<br/>'.esc_html__('We are using Yahoo Finance API previously and Yahoo discontinue that system. Now our system using Currencylayer.com API.', 'pointfindert2d'),
                            ),
                        array(
                        ...
                        array(
                            ...
                            'desc' => sprintf(esc_html__('Please write 3 char currency code. You can find currency codes from %s https://en.wikipedia.org/wiki/ISO_4217 %s', 'pointfindert2d'),'<a href="https://en.wikipedia.org/wiki/ISO_4217" target="_blank">','</a>').'<br/><strong>'.esc_html__('Currencylayer does allow to use USD currency for source if you using free plan. Please signup a paid plan for use different currencies.', 'pointfindert2d').'</strong>',
                            "default" => 'USD',
                            'required' => array('st9_currency_status','=',1)
                        ) ,
                        array(
                            'id' => 'st9_currency_key',
                            'type' => 'text',
                            'title' => esc_html__('Currency Layer API Key', 'pointfindert2d') ,
                            'desc' => sprintf(esc_html__('Please copy and write currencylayer.com API key from %s https://currencylayer.com %s', 'pointfindert2d'),'<a href="https://currencylayer.com" target="_blank">','</a>'),
                            "default" => '',
                            'required' => array('st9_currency_status','=',1)
                        ) ,
                        array(
                            ...
                            'desc' => sprintf(esc_html__('Please write currency codes with comma separated. Ex: EUR,GPB,TRY %s You can find currency codes from %s https://en.wikipedia.org/wiki/ISO_4217 %s', 'pointfindert2d'),'<br>','<a href="https://en.wikipedia.org/wiki/ISO_4217" target="_blank">','</a>').'<br/>'.esc_html__('Please do not leave space between commas', 'pointfindert2d'),
                            "default" => '',
                            'required' => array('st9_currency_status','=',1)
                        ),
                        array(
