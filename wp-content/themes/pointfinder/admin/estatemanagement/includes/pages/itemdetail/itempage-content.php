								...
								$tabinside .= '<section role="itempagemap" class="pf-itempage-maparea pf-itempage-elements">';
									...
									$tabinside .= '<div id="pf-itempage-page-map-directions" class="golden-forms pf-container"><form id="pf-itempage-page-map-directions-form">';
										$tabinside .= '<div class="pf-row">';
											...
											$tabinside .= '<a class="button gdbutton" style="cursor:pointer;">'.esc_html__('Get Direction','pointfindert2d').'</a>';
											$tabinside .= '</div>';
											$tabinside .= '<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">';
											$tabinside .= '<a class="button gdbutton2" href="https://maps.google.com?saddr=Current+Location&daddr='.esc_html(get_post_meta( get_the_id(), 'webbupointfinder_items_location', true )).'" target="_blank" rel="nofollow">'.esc_html__('Map Direction','pointfindert2d').'</a>';
											$tabinside .= '</div>';
										$tabinside .= '</form></div>';
									$tabinside .= '</div>';
