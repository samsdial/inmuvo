...
/*For locations*/
	...
	if ($setup3_pointposttype_pt5_check == 1) {
		...
		$pf_extra_taxonomyfields[] = array(
			'title' => esc_html__("Visual Composer : Image Grid Settings",'pointfindert2d'),			
			'taxonomies' => array('pointfinderlocations'),			
			...
			'fields' => array(							
				...
				array(
					'name' => esc_html__('Grid Gallery Image','pointfindert2d'),
					'id'   => 'pf_timage_of_listing',
					'type' => 'image',
				),
				array(
					'name' => esc_html__('Grid Gallery Size','pointfindert2d'),
					'desc' => sprintf(esc_html__('Please select grid gallery size for masonry tiled gallery.','pointfindert2d'),'<br/>'),
					'id'   => 'pf_masonry_size',
					'type' => 'radio',
					'options' => array(
						'large' => esc_html__('Large','pointfindert2d'),
						'wide' => esc_html__('Wide','pointfindert2d'),
						'box' => esc_html__('Box','pointfindert2d')
						),
					'std'  => 'box',
				),
...
/*For listing Types*/
		...
		'fields' => array(	
			array(
				...
				'options' => array(
					...
					'2' => esc_html__("Standard Header",'pointfindert2d'),
	...
	$pf_extra_taxonomyfields[] = array(
		'title' => esc_html__('Visual Composer : Directory List & Image Grid Settings','pointfindert2d'),			
		'taxonomies' => array('pointfinderltypes'),			
	...
	$pf_extra_taxonomyfields[] = array(
		...
		'fields' => array(	
			...
			array(
				'name' => esc_html__('Header Image Upload Area','pointfindert2d'),
				'desc' => esc_html__('Hide Image Upload Area from frontend form.','pointfindert2d'),
				'id'   => 'pf_header_area',
				'type' => 'radio',
				'options' => array(
