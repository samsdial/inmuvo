			...
			function GSF($params = array()){
				...
				switch($ftype){	
					...
					case 'selectt3': //Target for select box for text field
					    ...
					    $selectableptypes['title_description'] = esc_html__('Title & Content(Desc.) of the item','pointfindert2d');
					    $selectableptypes['title_description_listing'] = esc_html__('Title & Content(Desc & Listing Types.)','pointfindert2d');
					    $selectableptypes['search_all'] = esc_html__('SEARCH EVERYTHING','pointfindert2d');
						...
						$selectableptypes['post_tags'] = esc_html__('Post Tags','pointfindert2d');
				...
				switch($field){
					...
					case 'ajaxloads':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('Ajax Load for Listing Type & Location','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('If it is enabled, Post Taxonomy List will show only parent taxonomies and load sub categories with ajax. This function does not work with mini search. THIS FEATURE ONLY WORKING WITH LISTING TYPES AND LOCATIONS','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_rvalues_check', 'condition' => '=', 'required_condition_text' => '0')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					*/
					case 'autocmplete':
						$this_field_arr = array(
								...
								'ftype' => 'switch',
								'fdesc' => esc_html__('If want to use autocomplete for title, address and taxonomies then enable.','pointfindert2d'),
					...
					case 'searchall_click':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Click to Show All Listing Types','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('System will show Listing Types on search field click.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_title':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Title','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include title of item to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_desc':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Content','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include content of item to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_listingtype':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Listing Types','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include listing types to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_itemtypes':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Item Types','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include item types to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_locations':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Locations','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include locations to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_features':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Features','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include features to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
					...
					case 'searchall_tags':
						$this_field_arr = array(
								...
								'ftitle' => esc_html__('SEARCH ALL: Include Tags','pointfindert2d'),
								'ftype' => 'switch',
								'fdesc' => esc_html__('This will include tags to the search system.','pointfindert2d'),
								'fdata' => array('default'=>0,'on'=>esc_html__('Enable','pointfindert2d'),'off'=>esc_html__('Disable','pointfindert2d'),'required'=>'setupsearchfields_'.$slug.'_target_target', 'condition' => '=', 'required_condition_text' => 'search_all')
						);
						return $this->GSF($this_field_arr);
						break;
