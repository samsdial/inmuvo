...
function pointfinder_widgets_init() {
	...
	if (function_exists('register_sidebar'))
	{
      ...
      register_sidebar(array(
	        'name' => esc_html__('PF Blog Search Results Sidebar', 'pointfindert2d'),
	        'description' => esc_html__('Widget area for blog search results page.', 'pointfindert2d'),
...
\*------------------------------------*/
if(!function_exists('pf_invoices_mainfix')){
