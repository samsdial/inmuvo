...
if (is_user_logged_in()) {
	if (current_user_can('activate_plugins')) {
		...
		if(!function_exists('pf_dashboard_widget_scripts')){
		...
		if(!function_exists('pf_prefix_add_dashboard_widget')){
		...
		if(!function_exists('pf_prefix_add_dashboard_widget2')){
		...
		if(!function_exists('pf_status_of_system')){
		...
		if(!function_exists('pf_status_of_system2')){
